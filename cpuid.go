...
const (
	...
	AVX512VBMI2                 // Additional byte, word, dword and qword capabilities
	...
	AVX512BITALG                // Support for VPOPCNT[B,W] and	VPSHUFBITQMB
	AVX512VPOPCNTDQ             // Support for VPOPCNT[D,Q]
	AVX512BF16                  // Support for BFLOAT16 instructions
